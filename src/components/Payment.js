...
const Payment = () => {
  ...
  if (paymentSuccess) {
    return (
      <div className="payment-success">
        <h2>Room Booked!</h2>
        <p>
          Congratulations! Your room has been successfully booked for{' '}
          {new Date(bookingDateTime).toLocaleString()}. Thank you for choosing our hotel!
        </p>
  ...
  return (
    <div className="payment-container" style={{ backgroundColor: 'linear-gradient(to bottom,  #FFFFFF, #FF0000)' }}>
      <h2>Book Your Dream Room</h2>
      {room && (
